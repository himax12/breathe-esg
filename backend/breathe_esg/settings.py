...
# Database
# Use DATABASE_URL from environment, fallback to SQLite for local dev without PostgreSQL
...
# Frontend build output directory (for serving React in production)
FRONTEND_DIST_ROOT = BASE_DIR.parent / 'frontend' / 'dist'
